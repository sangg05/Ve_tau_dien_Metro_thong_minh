...
class TicketAdmin(admin.ModelAdmin):
    list_display = ('ticket_id', 'user', 'ticket_type', 'price', 'valid_from', 
                    'valid_to', 'ticket_status', 'start_station', 'end_station')
    search_fields = ('ticket_id', 'user__email', 'user__full_name') 
    list_filter = ('ticket_status', 'ticket_type')
    list_editable = ('ticket_status',) 
    ordering = ('valid_from',)

    actions = ['block_tickets', 'unblock_tickets']
    ...
    block_tickets.short_description = "Block selected tickets"
    ...
    unblock_tickets.short_description = "Unblock selected tickets"
